class Passenger:
    ...
    related to an airline passenger
    """
...
class TicketAgent:
    ...
    def is_free(self):
        """
        Determines if the ticket agent
        is free to assist a passenger
        """
    ...
    def is_finished(self, current_time):
        """
        Determines if the ticket agent
        has finished helping the passenger
        """
        return self._passenger is not None and \
            self._stop_time == current_time

    def start_service(self, passenger, stop_time):
        """
        Indicates the ticket agent
        has begun assisting a passenger
        """
